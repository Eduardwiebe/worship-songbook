...
- **Cross-links:** the page header and the login screen show Lyruma and Eduard Wiebe next to Install. The footer websites nav (Lyruma, Eduard Wiebe) and the footer Install link stay. Install, Impressum, Datenschutz, and Nutzungsbedingungen footers link the same hosts.
