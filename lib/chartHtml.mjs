...
import { preferSongTitle } from './songMetadata.mjs'
...
export function renderChartHtmlDocument({
  ...
  const cleanTitle = preferSongTitle({ nativeTitle: title, hint: title })
  ...
  return `<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${escapeHtml(cleanTitle)} – ${escapeHtml(targetKey)}</title><style>
...
.chart-sheet{color:#1a222b;font:${size}px/1.45 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-variant-ligatures:none;white-space:normal;overflow-x:hidden;width:100%;min-width:0;max-width:100%;box-sizing:border-box}
.chart-sheet.columns-2{column-count:2;column-gap:32px;column-rule:1px solid #edf0f2;column-fill:balance}
.chart-chords{color:#b71c1c;font-weight:700;min-height:1.15em;white-space:pre-wrap;overflow-wrap:anywhere;margin:0 0 .45em}
...
.chart-pair{display:flex;flex-wrap:wrap;align-items:flex-end;gap:.28em .65em;margin:0 0 1.05em;width:100%;min-width:0;max-width:100%;break-inside:avoid;page-break-inside:avoid;-webkit-column-break-inside:avoid}
.chart-stack{display:inline-flex;flex-direction:column;align-items:flex-start;min-width:0;max-width:100%;gap:.12em}
.chart-stack-chord{color:#b71c1c;font-weight:700;min-height:1.2em;line-height:1.2;white-space:normal}
...
.chart-stack-word{color:#15202b;font-weight:550;min-height:1.2em;line-height:1.25;white-space:normal;overflow-wrap:anywhere;font-family:"Segoe UI",system-ui,-apple-system,sans-serif}
...
</style></head><body><main><h1>${escapeHtml(cleanTitle)}</h1>${metaHtml}<div class="${sheetClass}">${body}</div></main></body></html>`
}
